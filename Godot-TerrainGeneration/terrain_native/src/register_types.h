 ...
 * @brief Declares GDExtension module initialization/termination entry points for terrain_native.
 *
 * Godot calls the initializer/terminator at various module initialization levels.
 * We only register classes at @ref MODULE_INITIALIZATION_LEVEL_SCENE.
 */
